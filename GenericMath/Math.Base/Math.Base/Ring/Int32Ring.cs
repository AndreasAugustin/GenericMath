//  *************************************************************
// <copyright file="Int32Ring.cs" company="${Company}">
...
namespace Math.Base
{
    ...
    public class Int32Ring : Int32Group, IRing<Int32>
    {
        ...
        {
            return String.Format("[{0}: Zero={1}, One={2} Generic argument type: {3}]", this.GetType().Name, this.Zero, this.One, typeof(Int32));
        }
