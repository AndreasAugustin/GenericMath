//  *************************************************************
// <copyright file="ComplexRing.cs" company="${Company}">
...
namespace Math.Base
{
    ...
    public class ComplexRing : ComplexGroup, IRing<Complex>
    {
        ...
        public Complex Multiplication(Complex leftElement, Complex rightElement)
        {
        ...
        {
            return String.Format("[{0}: Zero={1}, One={2}, Generic argument type: {3}]", this.GetType().Name, this.Zero, this.One, typeof(Complex));
        }
