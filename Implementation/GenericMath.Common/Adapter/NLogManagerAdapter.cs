...
namespace GenericMath.Common
{
    ...
    public sealed class NLogManagerAdapter : ILoggerManager, IDisposable
    {
        ...
        private Dictionary<String, GenericMath.Common.Contracts.ILogger> _loggerPool = new Dictionary<String, GenericMath.Common.Contracts.ILogger>();
        ...
        public GenericMath.Common.Contracts.LogLevel GlobalThreshold
        {
            get
            {
        ...
        public GenericMath.Common.Contracts.ILogger GetLogger (String loggerName)
        {
