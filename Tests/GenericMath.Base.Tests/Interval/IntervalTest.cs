...
namespace GenericMath.Base.Tests
{
        ...
        where TStruct : IStructure, new()
    {
        ...
        protected abstract IEnumerable<TestCaseData> ConstructTestDataSource { get; }

        /// <summary>
        /// Gets the construct throws test data source.
        /// </summary>
        /// <value>The construct throws test data source.</value>
        protected abstract IEnumerable<TestCaseData> ConstructThrowsTestDataSource { get; }

        /// <summary>
        /// Gets the test data source.
        /// </summary>
        /// <value>The test data source.</value>
        protected abstract IEnumerable<TestCaseData> TestDataSource { get; }
